  ...
  return (
    <>
      <Container>
        <p>
          非常歡迎您光臨「Fingerstyle
          Taiwan網站」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        </p>
        ...
        <List>
          <List.Item>經由您書面同意。</List.Item>
          <List.Item>法律明文規定。</List.Item>
          <List.Item>為免除您生命、身體、自由或財產上之危險。</List.Item>
          <List.Item>
