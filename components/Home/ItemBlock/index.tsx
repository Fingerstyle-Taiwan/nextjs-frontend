...
const ItemBlock = (props: ItemBlockProps) => {
  ...
  return (
    <div className="w-56 h-36 bg-[#f8fafc] rounded-2xl flex flex-col justify-between items-center pt-[22px] pb-4">
      ...
      <div>
        <div className="desc text-base lg:text-xl font-semibold text-mainDark">{desc1}</div>
        <div className="desc text-base lg:text-xl font-semibold text-mainDark">{desc2}</div>
      </div>
    </div>
  );
}
