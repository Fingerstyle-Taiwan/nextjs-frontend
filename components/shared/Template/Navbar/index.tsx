...
const Navbar = () => {
  ...
  return (
    <nav className="h-18 lg:h-24 w-screen fixed top-0 flex py-3.5 px-4 lg:py-6 lg:px-16 items-center justify-between z-50 bg-background">
      ...
      <div className={`mobile-menu-container overflow-hidden bg-background block lg:hidden duration-300 h-96 top-[68px] px-4 w-full fixed left-0 flex flex-col justify-between ${showMenu ? 'h-full py-6' : 'h-0 py-0'}`}>
